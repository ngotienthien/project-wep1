        ...
        <ul class="list-item clearfix owl-carousel owl-theme" style="opacity: 1; display: block;">
            <div class="owl-wrapper-outer">
                ...
                <div class="container">
                    <div class="row">
                <?php 
                    $sql = "SELECT * from sanpham order by DATE(NgayNhap) desc limit 10";
                    ...
                    <div class="col-md-3">
                        <li>
                            ...
                            <div class="info">
                                ...
                                <a href="pages/GioHang/xlDatHang.php?id=<?php echo $row["MaSanPham"]; ?>&gia=<?php echo $row["GiaSanPham"]; ?>" title="" class="buy-now">Mua ngay</a>
                            </div>
